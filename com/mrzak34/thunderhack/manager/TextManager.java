...
public class TextManager extends Feature
{
    ...
    public void init(final boolean startup) {
        final FontMod cFont = (FontMod)Thunderhack.moduleManager.getModuleByClass((Class)FontMod.class);
        try {
    ...
    public void drawString(final String text, final float x, final float y, final int color, final boolean shadow) {
        if (Thunderhack.moduleManager.isModuleEnabled(FontMod.getInstance().getName())) {
            if (shadow) {
    ...
    public void drawStringForCompass(final String text, final float x, final float y, final int color, final boolean shadow) {
        this.customFont.drawStringWithShadow(text, (double)x, (double)y, color);
    }
