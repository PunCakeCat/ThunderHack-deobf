...
public class HoleUtil
{
    ...
    public static boolean isInHole(final Entity e, final boolean onlyOneWide, final boolean ignoreDown) {
    ...
    public static boolean isAir(final BlockPos pos) {
        return HoleUtil.mc.world.getBlockState(pos).getBlock() == Blocks.AIR;
    }
