...
package com.mrzak34.thunderhack.features;
...
public class Feature implements Util
{
    ...
    public Feature() {
        ...
        this.renderer = Thunderhack.textManager;
    }
    ...
    public Setting register(final Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof HudEditorGui) {
