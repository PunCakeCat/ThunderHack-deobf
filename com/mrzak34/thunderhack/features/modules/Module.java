...
package com.mrzak34.thunderhack.features.modules;
...
public class Module extends Feature
{
    ...
    public Module(final String name, final String description, final Category category, final boolean hasListener, final boolean hidden, final boolean alwaysListening) {
        ...
        if (Objects.equals(name, "ThunderGUI")) {
            this.bind = (Setting<Bind>)this.register(new Setting("Keybind", (T)new Bind(25)));
        }
    }
    ...
    public void setSetting(final Boolean a) {
    ...
    public void enable() {
        ...
        this.onToggle();
        this.onEnable();
        if (!Objects.equals(this.getDisplayName(), "ElytraSwap") && !Objects.equals(this.getDisplayName(), "ACRender") && !Objects.equals(this.getDisplayName(), "ClickGui") && !Objects.equals(this.getDisplayName(), "ThunderGui") && !Objects.equals(this.getDisplayName(), "Windows")) {
        ...
        if (ClickGui.getInstance().notifyToggles.getValue()) {
    ...
    public void disable() {
        ...
        if (!Objects.equals(this.getDisplayName(), "ElytraSwap") && !Objects.equals(this.getDisplayName(), "ACRender") && !Objects.equals(this.getDisplayName(), "ThunderGui") && !Objects.equals(this.getDisplayName(), "ClickGui") && !Objects.equals(this.getDisplayName(), "Windows")) {
    ...
    public boolean isValidBind(final String s) {
        return s.length() < 2;
    }
    ...
    public void setDisplayName(final String name) {
        final Module module = Thunderhack.moduleManager.getModuleByDisplayName(name);
        final Module originalModule = Thunderhack.moduleManager.getModuleByName(name);
