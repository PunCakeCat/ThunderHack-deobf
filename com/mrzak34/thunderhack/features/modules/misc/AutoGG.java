...
public class AutoGG extends Module
{
    ...
    public AutoGG() {
        super("AutoGG", "\u043a\u0440\u0438\u043d\u0436", Category.MISC, true, false, false);
        this.custom = (Setting<String>)this.register(new Setting("Custom", (T)"ThunderHackPlus"));
        this.test = (Setting<String>)this.register(new Setting("Test", (T)"bruh"));
