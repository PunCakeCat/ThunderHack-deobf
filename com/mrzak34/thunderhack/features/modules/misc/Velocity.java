...
public class Velocity extends Module
{
    ...
    private Velocity IceSpeed;
    
    public Velocity() {
        super("Velocity", "\u0430\u043a\u044d\u0431\u044d\u0448\u043a\u0430", Category.MOVEMENT, true, false, false);
    ...
    public void onUpdate() {
        final Velocity iceSpeed = this.IceSpeed;
        if (getINSTANCE().isOff() && this.ice.getValue()) {
