...
public class NoRender extends Module
{
    ...
    public NoRender() {
        ...
        this.noarmorstands = (Setting<Boolean>)this.register(new Setting("ArmorStands", (T)Boolean.FALSE, "Removes the portal overlay."));
        this.fire = (Setting<Boolean>)this.register(new Setting("Fire", (T)Boolean.FALSE, "Removes the portal overlay."));
        this.blin = (Setting<Boolean>)this.register(new Setting("Blind", (T)Boolean.FALSE, "Removes the portal overlay."));
        this.portal = (Setting<Boolean>)this.register(new Setting("Portal", (T)Boolean.FALSE, "Removes the portal overlay."));
        this.pumpkin = (Setting<Boolean>)this.register(new Setting("Pumpkin", (T)Boolean.FALSE, "Removes the pumpkin overlay."));
        this.totemPops = (Setting<Boolean>)this.register(new Setting("TotemPop", (T)Boolean.FALSE, "Removes the Totem overlay."));
        this.items = (Setting<Boolean>)this.register(new Setting("Items", (T)Boolean.FALSE, "Removes items on the ground."));
        this.nausea = (Setting<Boolean>)this.register(new Setting("Nausea", (T)Boolean.FALSE, "Removes Portal Nausea."));
        this.hurtcam = (Setting<Boolean>)this.register(new Setting("HurtCam", (T)Boolean.FALSE, "Removes shaking after taking damage."));
        this.explosions = (Setting<Boolean>)this.register(new Setting("Explosions", (T)Boolean.FALSE, "Removes crystal explosions."));
        this.fog = (Setting<Fog>)this.register(new Setting("Fog", (T)Fog.NONE, "Removes Fog."));
        this.noWeather = (Setting<Boolean>)this.register(new Setting("Weather", (T)Boolean.FALSE, "AntiWeather"));
        this.boss = (Setting<Boss>)this.register(new Setting("BossBars", (T)Boss.NONE, "Modifies the bossbars."));
        this.scale = (Setting<Float>)this.register(new Setting("Scale", (T)0.5f, (T)0.5f, (T)1.0f, v -> this.boss.getValue() == Boss.MINIMIZE || this.boss.getValue() == Boss.STACK, "Scale of the bars."));
        this.bats = (Setting<Boolean>)this.register(new Setting("Bats", (T)Boolean.FALSE, "Removes bats."));
        ...
        this.barriers = (Setting<Boolean>)this.register(new Setting("Barriers", (T)Boolean.FALSE, "Barriers"));
