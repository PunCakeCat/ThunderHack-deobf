...
public class CrystalModifier extends Module
{
    ...
    public CrystalModifier() {
        super("CrystalModifier", "\u0438\u0437\u043c\u0435\u043d\u044f\u0435\u0442 \u0432\u0438\u0434 \u043a\u0440\u0438\u0441\u0442\u0430\u043b\u043b\u0430", Module.Category.RENDER, true, false, false);
    ...
    public void onRenderModel(final RenderEntityModelEvent event) {
        ...
        final Color color = this.colorSync.getValue() ? ClickGui.getInstance().mainColor.getValue().getColorObject() : EntityUtil.getColor(event.entity, this.red.getValue(), this.green.getValue(), this.blue.getValue(), this.alpha.getValue(), false);
