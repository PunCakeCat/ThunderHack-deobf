...
public class WexsideSpeed extends Module
{
    ...
    public WexsideSpeed() {
        super("WexsideSpeed", "WexsideSpeed", Category.HUD, true, false, false);
    ...
    public void onRender2D(final Render2DEvent e) {
        final ScaledResolution sr = new ScaledResolution(WexsideSpeed.mc);
        ...
        GL11.glEnable(3042);
        this.status = (int)(360.0 / (50.0 / Thunderhack.speedManager.getSpeedKpH()));
        ...
        FontRendererWrapper.drawCenteredString(String.valueOf(Thunderhack.speedManager.getSpeedKpH()), (this.x1 + this.xrounded.getValue()) / 1.5f, (this.y1 + this.yrounded.getValue()) / 1.5f, -1);
        GL11.glScalef(1.0f, 1.0f, 1.0f);
        GL11.glPopMatrix();
        FontRendererWrapper.drawCenteredString("SPEED", this.x1 + 17.5f, this.y1 + 3.0f, -1);
    }
