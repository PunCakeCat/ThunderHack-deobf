...
public class WexsideArmor extends Module
{
    ...
    public WexsideArmor() {
        super("WexsideArmor", "WexsideArmor", Category.HUD, true, true, false);
    ...
    public void onRender2D(final Render2DEvent e) {
        final ScaledResolution sr = new ScaledResolution(WexsideArmor.mc);
        this.y1 = sr.getScaledHeight() / (1000.0f / this.imageScaleY.getValue());
        this.x1 = sr.getScaledWidth() / (1000.0f / this.imageScaleX.getValue());
        ...
        GL11.glEnable(3042);
        this.status = 360 / (1815 / DamageUtil.ChekTotalarmorDamage((EntityPlayer)WexsideArmor.mc.player));
        ...
        FontRendererWrapper.drawCenteredString(String.valueOf(DamageUtil.ChekTotalarmorDamage((EntityPlayer)WexsideArmor.mc.player)), this.x1 + this.xrounded.getValue(), this.y1 + this.yrounded.getValue(), -1);
        GL11.glScalef(1.0f, 1.0f, 1.0f);
        GL11.glPopMatrix();
        FontRendererWrapper.drawCenteredString("ARMOR", this.x1 + 17.5f, this.y1 + 3.0f, -1);
    }
