...
public class CFontRenderer2 extends CFont
{
    ...
    public CFontRenderer2(final Font font, final boolean antiAlias, final boolean fractionalMetrics) {
        ...
        if (this.getStringWidth(text) > width) {
            ...
            if (currentWord.length() > 0) {
                if (this.getStringWidth(currentWord.toString()) < width) {
                    ...
                    for (final String s : this.formatString(currentWord.toString(), width)) {
                        finalWords.add(s);
                    }
                }
            }
